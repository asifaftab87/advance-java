...
<html>
	...
	<body>
		...
		<div>
			<form action="/asif-project1/EmployeeTwo/add">
		...
		<div>
			<form action="/asif-project1/EmployeeTwo/Name">
		...
		<div>
			<form action="/asif-project1/EmployeeTwo/Email">
		...
		<div>
			<form action="/asif-project1/EmployeeTwo/Noticeperiod">
		...
		<div>
			<form action="/asif-project1/EmployeeTwo/Gender">
		...
		<div>
			<form action="/asif-project1/EmployeeTwo/Dob">
		...
		<div>
			<form action="/asif-project1/EmployeeTwo/JoinedDate">
		...
		<div>
			<form action="/asif-project1/EmployeeTwo/ReleaseDate">
				...
				if(!employeetwoList.isEmpty()){
					for(EmployeeTwo employeetwo : employeetwoList){
						%>
							<tr>
								<td>
									<a href="/asif-project1/EmployeeTwo/Detail?employeetwoid=<%= employeetwo.getId() %>">
										<%= employeetwo.getName() %>
									</a>
								</td>
								...
								<td>
									<a href="/asif-project1/EmployeeTwo/Delete?employeetwoid=<%= employeetwo.getId() %>">Delete</a>
									<a href="/asif-project1/EmployeeTwo/Update?employeetwoid=<%= employeetwo.getId() %>">Update</a>
								</td>
							</tr>
						<%
					}
