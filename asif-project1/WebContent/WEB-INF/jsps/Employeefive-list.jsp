...
<html>
	...
	<body>
		...
		<div>
			<form action="/asif-project1/Employeefive/add">
		...
		<div>
			<form action="/asif-project1/Employeefive/search">
		...
		<div>
			<form action="/asif-project1/Employeefive/searchEmail">
		...
		<div>
			<form action="/asif-project1/Employeefive/searchPeriod">
		...
		<div>
			<form action="/asif-project1/Employeefive/searchGender">
		...
		<div>
			<form action="/asif-project1/Employeefive/searchAge">
		...
		<div>
			<form action="/asif-project1/Employeefive/searchJoined">
		...
		<div>
			<form action="/asif-project1/Employeefive/searchRelease">
				...
				if(!empList.isEmpty()){
					for(Employeefive emp : empList){
						%>
							<tr>
								<td>
									<a href="/asif-project1/Employeefive/detail?empId=<%= emp.getId() %>">
										<%= emp.getName() %>
									</a>
								</td>
								...
								<td>
									<a href="/asif-project1/Employeefive/update?empId=<%= emp.getId() %>">Update</a>
								</td>
							</tr>
						<%
					}
