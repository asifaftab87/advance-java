...
@WebServlet("/EmployeeOneSearchController")
public class EmployeeOneSearchController extends HttpServlet {
...
protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("search employeeOne by name: "+name);
		
		EmployeeOneService employeeOneService = new EmployeeOneService();
		
		try {
			
			List<EmployeeOne> employeeOneList = employeeOneService.getEmployeeOneByName(name);
